...
# Include sequencing (multiple lines of code). 7
# Utilize selection (e.g., if/else statements). 7
# Use iteration (e.g., loops like for or while). 7
# Take different paths based on parameter values. 7
